...
class DropaiPreprocessorManager extends DefaultPluginManager {
  ...
  public function __construct(\Traversable $namespaces, CacheBackendInterface $cache_backend, ModuleHandlerInterface $module_handler) {
    parent::__construct('Plugin/DropaiPreprocessor', $namespaces, $module_handler, 'Drupal\dropai\Plugin\DropaiPreprocessorInterface', 'Drupal\dropai\Annotation\DropaiPreprocessor');
